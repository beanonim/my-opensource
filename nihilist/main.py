...
{g}║                      [{w}&{g}] {w}Telegram Channel: {g}@{w}NihilistSoftware{g}                        ║    ║   [{w}12{g}] {w}Поиск по TikTok{g}             [{w}26{g}] {w}Поиск по Карте{g}                [{w}40{g}] {w}Управление Сессией{g}                 ║   
{g}║                      [{w}&{g}] {w}Authors: {g}Tree{w}Hugger, {g}@{w}VkMard{g}                               ║    ║   [{w}13{g}] {w}Поиск по ОК{g}                 [{w}27{g}] {w}AI Analyze{g}                    [{w}41{g}] {w}Поиск по Viber{g}                     ║   
