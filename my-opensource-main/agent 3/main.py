...
{g}║                                                                                     ║    ║                                                                                                               ║   
{g}║{w}      █████╗  ███████╗ ███████╗ ███╗  ██╗ ████████╗                                 ║    ║            [{w}01{g}] {w}Поиск по Номеру{g}             [{w}15{g}] {w}Поиск по MAC{g}                  [{w}29{g}] {w}Поиск по VIN Автомобиля{g}            ║   
{g}║{w}     ██╔══██╗ ██╔════╝ ██╔════╝ ████╗ ██║ ╚══██╔══║                                               ║   [{w}02{g}] {w}Поиск по Email{g}              [{w}16{g}] {w}Поиск по Github{g}               [{w}30{g}] {w}Поиск по Pikabu{g}                    ║   
{g}║{w}     ███████║ █████╗   █████╗   ██╔██╗██║    ██║                                                  ║   [{w}03{g}] {w}Поиск по никнейму{g}           [{w}17{g}] {w}Поиск по Wikipedia{g}            [{w}31{g}] {w}Поиск через Shodan{g}                 ║   
{g}║{w}     ██╔══██║ ██╔══╝   ██╔══╝   ██║╚████║    ██║                                                 ║   [{w}04{g}] {w}Поиск по Телеграмм{g}          [{w}18{g}] {w}Поиск по Steam{g}                [{w}32{g}] {w}Поиск по паролю{g}                    ║   
{g}║{w}     ██║  ██║ ███████╗ ███████╗ ██║ ╚███║    ██║                                                  ║   [{w}05{g}] {w}Поиск по ВК{g}                 [{w}19{g}] {w}Поиск по Компаниям{g}            [{w}33{g}] {w}Поиск по ИНН (Казахстан){g}           ║   
{g}║{w}     ╚═╝  ╚═╝ ╚══════╝ ╚══════╝ ╚═╝  ╚══╝    ╚═╝                                                   ║   [{w}06{g}] {w}Поиск по Номеру Авто{g}        [{w}20{g}] {w}HLR Запрос{g}                    [{w}34{g}] {w}Поиск по Minecraft{g}                 ║   
{g}║{w}                                                                                                ║   [{w}07{g}] {w}Поиск по ФИО{g}                [{w}21{g}] {w}Поиск по WhatsApp{g}             [{w}35{g}] {w}Парсинг Чатов{g}                      ║   
{g}║{w}                                                                                              ║    ║   [{w}08{g}] {w}Поиск по ИНН{g}                [{w}22{g}] {w}Поиск по Домену{g}               [{w}36{g}] {w}Слежка{g}                             ║   
{g}║                                                                                     ║    ║   [{w}09{g}] {w}Поиск по Паспорту{g}           [{w}23{g}] {w}Поиск по Доркам{g}               [{w}37{g}] {w}Поиск по Перелётам{g}                 ║   
...
{g}║                      [{w}&{g}] {w}Version: {g}AGENT {w}1.0                                        ║    ║   [{w}14{g}] {w}Поиск по Instagram{g}          [{w}28{g}] {w}SMTP Валидатор{g}                [{w}42{g}] {w}Поиск по Skype{g}                     ║   
{g}║                                                                                     ║    ║                                                                                                               ║   
{g}╚═════════════════════════════════════════════════════════════════════════════════════╝    ╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╝  
